...
Die Abschreibung $DEP$ ist anhand Gesamtinvestitionen für das Flugzeug $TI$ und Auslastung des Flugzeugs $U$ berechnet
und mit einen Verzinsprozentanteil von 5 \% \cite{scholz_design_evaluation_doc}.
Versicherungskosten $INS$ sind normalerweise anhand Herstellerpreises berechnet. 
Es wird angenommen, dass Herstellerpreis nicht stark sich 
vom dem Kaufpreis unterscheidet und somit werden sich die Versicherungskosten auf Gesamtinvestitionen $TI$
für das Flugzeug beziehen. Versicherungsprozentanteil von 6 \% wird angenommen.
...
Nach AEA ist ein Versicherungsprozentanteil von 0,5 \% mitberechnet \cite{scholz_design_evaluation_doc}.

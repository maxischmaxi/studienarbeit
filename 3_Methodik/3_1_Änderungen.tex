...
die Flugzeugabfertigung zum Einsatz kommt. %ich denke so ist besser
...
die besagt, dass es verboten sein wird, reines SAF nicht als Drop-In zu nutzen. % MAX: ist oder sein wird?
...
nicht anwendbaren Schnellladung vorstellbar \cite{avogadro2024demystifying}. %es ist anwendbar, existiert einfach noch nocht

Bei der \textit{Swap-Methode} kann den Aus- und Einbau der Batterie aus 
...
Diese Investitionskosten werden die Flughafenbetreiber beeinträchtigen.\\ % MAX: beeinträchtigen oder belasten?
\textit{Transport}\\

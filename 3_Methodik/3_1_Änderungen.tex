...
In naher Zukunft werden vor allem die großen Flugzeuge nicht mit BA-Antrieb entwickelt, 
...
Bis zum Jahr 2050 sind die BAs auf kleinere Flugzeuge 
...
Nichtsdestotrotz kann eine schnelle Ladung zur Stagnation der Lebensdauer einer Batterie führen (Quelle).
...
Bei der Umwandlung von Erdgas- in Wasserstoffleitungen können Kosten gespart werden. 
Es muss keine neue Infrastruktur gebaut, nur eine Umrüstung der 
Leitungen für den Transport von Wasserstoff durchgeführt werden \cite{undertaking2022strategic}.

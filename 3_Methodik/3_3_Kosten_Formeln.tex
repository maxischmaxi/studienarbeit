...
entsprechend eingesetzte Werte sind in der Anlage A zu finden. % MAX: anlage?
...
wie die sicherheits- oder emissionsabhängige Entgelte. Zur Reduktion der Komplexität in der Berechnung 
werden die jedoch nicht betrachtet.
...
Bei einem 18 Stunden-Betrieb resultiert das insgesamt 5 Ladezyklen pro Tag für jede Batterie. %Geli: resultiert insgesamt in 5 ..? was denkst du

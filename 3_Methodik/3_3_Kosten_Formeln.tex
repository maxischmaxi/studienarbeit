...
, wobei $P_{Bat}$ den Preis einer Batterie darstellt und $n_{Bat}$ die Anzahl der Batterien, die benötigt werden. 
...
(1 Flugzeug pro Tankwagen, also alles von - Ankunftsrate abhängig) % MAX: was meinst du damit?

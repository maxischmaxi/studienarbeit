...
Das flüssige \ce{LH2} muss bei -253 °C gelagert werden \cite{colpan2022fuel} und zusätzlich kann die Nutzung 
zu Versprödung der Materialien führen \cite{dahal2021techno}.
...
%"zyklische Belastungen, die durch die Wärmeausdehnung und -kontraktion beim Nachfüllen, sowie durch den Kraftstoffverbrauch verursacht werden" \cite{dahal2021techno}
...
wodurch der Propeller des Flugzeugs angetrieben wird. Aufgrund der besseren Speicherung in flüssiger Form muss bedenkt werden, wann der Wasserstoff in den Gaszustand überführt wird. 
...
allerdings der anspruchsvolle Wasserstofftank könnte häufigere Wartung bedürfen.
%
